...
def test_create_article():
    url = "http://localhost:8000/articles_management/create"
    content = """
    ...
    ACCESS_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhZG1pbl9pZCI6MiwiZXhwIjoxNzczOTM2NDc4fQ.S2g0vl4yQYkWMBhVVmVmNavo4JNW9SQW4y0pEehkgME"
